...
package Gir_Reader.Element_Lists is
   ...
   with Pre'Class => Self.Length >= Index;
   ...
   with Post'Class => Self.Length = Self'Old.Length + 1;
...
private
   ...
   type List is new Holders.Holder with null record with Put_Image => Image;
